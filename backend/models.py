# backend/models.py
from sqlalchemy import Column, Integer, String, Float, ForeignKey, DateTime, Text, Boolean, Enum, Date
...
class Engine(Base):
    ...
    # gss_sn = Column(String, nullable=True)  # Временно отключено - добавится через миграцию
